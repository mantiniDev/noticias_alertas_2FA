...
TITULOS_PAGINAS_GENERICAS: tuple[str, ...] = (
    r"processo\s+judicial\s+eletronico",
    r"detalhe\s+do\s+processo",
    r"consulta\s+processual",
    r"acesso\s+externo",
    r"pagina\s+inicial",
    r"^login$",
    r"acesso\s+ao\s+sistema",
    r"portal\s+do\s+advogado",
    r"portal\s+e.?processo",
    r"peticionamento\s+eletronico",
)
