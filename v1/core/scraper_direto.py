        ...
        "noticias": [
            {
                ...
                "tipo": "Notícias",
                "force_playwright": True,
                "wait_selector": "article, .views-row, h3 a, .news-item",
            },
        ],
    },
        ...
        "noticias": [
            {
                ...
                "tipo": "Notícias",
                "force_playwright": True,
                "wait_selector": "article, h3 a, .news-item, .noticia",
            },
        ],
    },
    # TJAM
        ...
        "noticias": [
            {
                ...
                "tipo": "Notícias",
                "skip": True,
                "skip_reason": "URL redireciona para login — sem listagem pública de notícias",
            },
        ],
    },
    {
        ...
        "noticias": [
            {
                ...
                "parser": "generic_news",
                "skip": True,
                "skip_reason": "site bloqueia scraper — fetch retorna None em todas as tentativas",
        ...
        "noticias": [
            {
                ...
                "tipo": "Notícias",
                "skip": True,
                "skip_reason": "formulário JSF com filtros — exige interação para listar resultados",
            },
        ],
    },
        ...
        "noticias": [
            {
                ...
                "parser": "generic_news",
                "skip": True,
                "skip_reason": "bot detection (Cloudflare JS challenge) — inacessível para scraper",
                "base_url": "https://www.trt17.jus.br",
                "tipo": "Notícias",
            },
        ],
        ...
        "noticias": [
            {
                ...
                "tipo": "Notícias",
                "force_playwright": True,
                "wait_selector": ".portlet-content, article, h3 a, .lista-noticias",
            },
        ],
    },
    # TRT24
